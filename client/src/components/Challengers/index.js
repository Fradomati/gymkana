...
import {
  ...
  modifyChallengerFN,
  findChallengerFN,
} from '../../services/Challenger_Services'
        ...
        <div>
          {!titleEdited ? (
            <FlexBtwContainer>
              ...
              <ButtonStore
                type="button"
                onClick={() => setTitleEdited(inputTitle)}
              >
                Editar
              </ButtonStore>
            </FlexBtwContainer>
              ...
              <li key={i}>
                {inputURL[i] != defValueURL ? (
                  <FlexBtwContainer>
                    ...
                    <Move
                      onClick={() => position(i, inputURL, setInputURL, -1)}
                    >
                      <div> ▴</div>
                    </Move>
